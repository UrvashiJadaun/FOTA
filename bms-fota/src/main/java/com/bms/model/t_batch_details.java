...
public class t_batch_details {
	...
	private String tcuCommand;
	
	private String bmsCommand;
	
	private String cfgCommand;
	
	private String tcuVersion;
	
	public String getTcuVersion() {
		return tcuVersion;
	}

	public void setTcuVersion(String tcuVersion) {
		this.tcuVersion = tcuVersion;
	}
...
public String getTcuCommand() {
		return tcuCommand;
	}

	public void setTcuCommand(String tcuCommand) {
		this.tcuCommand = tcuCommand;
	}

	public String getBmsCommand() {
		return bmsCommand;
	}

	public void setBmsCommand(String bmsCommand) {
		this.bmsCommand = bmsCommand;
	}

	public String getCfgCommand() {
		return cfgCommand;
	}

	public void setCfgCommand(String cfgCommand) {
		this.cfgCommand = cfgCommand;
	}
